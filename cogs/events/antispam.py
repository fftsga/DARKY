                ...
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      if data["punishment"] == "kick":
                        ...
                        hacker = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Kicked {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        ...
                        hacker1 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Banned {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        ...
                        hacker2 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            ...
                            hacker3 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Kicked {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            ...
                            hacker4 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Banned {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             ...
                             hacker5 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          ...
                          hacker6 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Kicked {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          ...
                          hacker7 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Banned {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          ...
                          hacker8 = discord.Embed(color=0x00FFE4,description=f"<:tick:1064554244105052161> | Successfully Muted {message.author} For Sending Links")
