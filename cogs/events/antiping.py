...
class antipinginv(Cog):
    ...
    async def on_message(self, message):
      button = Button(label="Invite", url =  "https://discord.gg/aashiquii")
      button1 = Button(label="Support", url = "https://discord.gg/aashiquii")
      try:
        ...
        with open("blacklist.json", "r") as f:
          ...
          if message.mention_everyone:
            ...
            if str(message.author.id) in data2["ids"]:
              embed = discord.Embed(title="<:error_ok:1002376341959757884> Blacklisted", description="You Are Blacklisted From Using My Commands.\nIf You Think That It Is A Mistake, You Can Appeal In Our Support Server By Clicking [here](https://discord.gg/aashiquii)")
              await message.reply(embed=embed, mention_author=False)
            else:

              embed = discord.Embed(description=f"""Hey, I'm **AASHIQUII**

Please use the following command instead: `{prefix}help`

If you continue to have problems, consider asking for help [Universal Development](https://discord.gg/aashiquii)""",color=0x00FFE4) 
              view = View()
