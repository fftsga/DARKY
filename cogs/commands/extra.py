...
cluster = motor.motor_asyncio.AsyncIOMotorClient(       "mongodb+srv://villan6278:8789693890@cluster0.x29qwdt.mongodb.net/?retryWrites=true&w=majority")
...
class Extra(commands.Cog):
    def __init__(self, bot):
        ...
        self.connection = mongodb.AsyncIOMotorClient(
          "mongodb+srv://villan6278:8789693890@cluster0.x29qwdt.mongodb.net/?retryWrites=true&w=majority"
        )
    ...
    async def stats(self, ctx):
        ...
        b = Button(label='Invite Me', style=discord.ButtonStyle.link, url='https://discord.com/api/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot')
        hacker = Button(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.gg/xbf3GarARa')
        ...
        embed = discord.Embed(color=0x00FFE4,description="[Invite](https://discord.com/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot) ● [Support Server](https://discord.gg/HP3gXrakcu)")
 
 
        embed.add_field(name='<a:stolen_emoji:1081853475400454204> • **Servers**', value=f'```Total: {serverCount} Server```')
        embed.add_field(name='<:stolen_emoji:1081853776366940180> • **Users**', value=f'```Total:{total_members} Users```')
        ...
        if hacker in ctx.guild.members:
            ...
            a = f'{hacker}'
        embed.add_field(name='<a:Developer:1009460008204914829> • **Developers**', value=f"{villan}")

        embed.set_author(name=f"{self.bot.user.name} Stats", icon_url=self.bot.user.display_avatar.url)
        embed.set_thumbnail(url="https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
        embed.set_footer(text='Thanks For Using AASHIQUII',icon_url= "https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
    ...
    async def invite(self, ctx: commands.Context):
        embed = discord.Embed(title="**Invite Link:**", description = "> • [Click Here To Invite AASHIQUII To Your Server](https://discord.com/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot)\n> • [Click Here To Join My Support Server](https://discord.gg/GTzUd3Ux)\n> • [Click Here To Vote AASHIQUII](https://discord.com/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot)", color=0x00FFE4, timestamp=ctx.message.created_at)
        ...
        b = Button(label='Invite Me', style=discord.ButtonStyle.link, url='https://discord.com/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot')
        hacker = Button(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.gg/GTzUd3Ux')
        #mohit = Button(label='Vote Me', style=discord.ButtonStyle.link, url='https://discord.com/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot')
        view = View()
        view.add_item(b)
        view.add_item(hacker)
        #view.add_item(mohit)
    ...
    @blacklist_check()
    @commands.command(aliases=['bi'], help="Get info about me!")
    async def botinfo(self, ctx: commands.Context):
        embed = discord.Embed(
            title="AASHIQUII Information`s",
            description="An Advance Antinuke Bot Made To Protect Your Servers From Nukers",
            color=0x00FFE4,
...
**Threads:** {len(guild.threads)}
    ...
    async def list_boost(self, ctx):
      ...
      embed.set_footer(text="Made With 💖 By villan#0774", icon_url="https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
    ...
    async def unbanall(self, ctx):
        button = Button(label="Yes", style=discord.ButtonStyle.green, emoji="<:tick:1064554244105052161>")
        button1 = Button(label="No", style=discord.ButtonStyle.red, emoji="<a:wronggg:1064554853432557591>")
        ...
        embed.set_footer(text="Made With 💖 By villan#0774")
    ...
    @commands.command(name="badges", help="Check what premium badges a user have.", aliases=["badge"],usage="Badges [user]")
    @blacklist_check()
    async def _badges(self, ctx, user: Optional[discord.User] = None):
      mem = user or ctx.author
      badges = getbadges(mem.id)
      if badges == []:
        embed2 = discord.Embed(description="**__BADGES__** <a:lgn_nitrobadgesroll:1064552224786751488>\n\n`No Badge Available`", color=0x00FFE4)
        embed2.set_author(name=f"Profile For {mem}", icon_url = "https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
        ...
        embed = discord.Embed(description="**__BADGES__** <a:lgn_nitrobadgesroll:1064552224786751488>\n\n",color=0x00FFE4)
        embed.set_author(name=f"Profile For {mem}",icon_url="https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
