...
#https://cdn.discordapp.com/avatars/974984890959425566/7fedaa654af7ec62b211033852e048d0.webp?size=2048
    ...
    try:
      with open('blacklist.json', 'r') as bl:
        ...
        if str(member.id) in blacklist["ids"]:
          ...
          embed = discord.Embed(title="Blacklisted", description=f"<:tick:1064554244105052161> | Successfully Blacklisted {member.name}", color=0x00FFE4)
          with open("blacklist.json") as file:
              blacklist = json.load(file)
              embed.set_footer(
  ...
  async def blacklist_remove(self, ctx, member: discord.Member = None):
    try:
      ...
      embed = discord.Embed(
                ...
                description=f"<:tick:1064554244105052161> | **{member.name}** has been successfully removed from the blacklist",
                color=0x00FFE4
            )
      with open("blacklist.json") as file:
        blacklist = json.load(file)
  ...
  async def np_add(self, ctx, user: discord.User):
    ...
    if user.id in np:
      ...
      #embed.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
    ...
    with open('info.json', 'w') as idk:
      ...
      embed1 = discord.Embed(
                title="AASHIQUII",
                description="<:tick:1064554244105052161> | Successfully **Added {} to no prefix!**".format(user),
                color=0x00FFE4
       )
  ...
  async def np_remove(self, ctx, user: discord.User):
    ...
    with open('info.json', 'w') as idk:
      ...
      embed2 = discord.Embed(
                title="AASHIQUII",
                description="<:tick:1064554244105052161> | **Removed {} from no prefix!**".format(user),
                color=0x00FFE4
       )
      #embed2.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
  ...
  async def badge_add(self, ctx, member: discord.Member, *, badge: str):
    ...
    if badge.lower() in ["own", "owner", "king"]:
      ...
      embed2 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Owner` Badge To {member}**",
                color=0x00FFE4
       )
      embed2.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      embed2.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed3 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Staff` Badge To {member}**",
                color=0x00FFE4
       )
      #embed3.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed4 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Partner` Badge To {member}**",
                color=0x00FFE4
       )
      #embed4.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed5 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Sponsor` Badge To {member}**",
                color=0x00FFE4
       )
      #embed5.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed1 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Owner's Friend` Badge To {member}**",
                color=0x00FFE4
       )
      #embed1.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
     # embed1.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      await ctx.reply(embed=embed1)
      ...
      embed6 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Early Supporter` Badge To {member}**",
                color=0x00FFE4
       )
      #embed6.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed7 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `VIP` Badge To {member}**",
                color=0x00FFE4
       )
      #embed7.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed8 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `Bug Hunter` Badge To {member}**",
                color=0x00FFE4
       )
      #embed8.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embedall = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Added `All` Badges To {member}**",
                color=0x00FFE4
       )
      #embedall.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
     # embedall.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      #hacker.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
  ...
  async def badge_remove(self, ctx, member: discord.Member, *, badge: str):
    ...
    if badge.lower() in ["own", "owner", "king"]:
      ...
      embed2 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Owner` Badge To {member}**",
                color=0x00FFE4
       )
      #embed2.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed2.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed3 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Staff` Badge To {member}**",
                color=0x00FFE4
       )
      #embed3.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      ...
      embed4 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Partner` Badge To {member}**",
                color=0x00FFE4
       )
      #embed4.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed4.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed5 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Sponsor` Badge To {member}**",
                color=0x00FFE4
       )
      #embed5.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed5.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed1 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Owner's Friend` Badge To {member}**",
                color=0x886ad1
       )
      #embed1.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed1.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed6 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `Early Supporter` Badge To {member}**",
                color=0x00FFE4
       )
      #embed6.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed6.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      embed7 = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `VIP` Badge To {member}**",
                color=0x00FFE4
       )
      #embed7.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embed7.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      ...
      #embed8.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
      await ctx.reply(embed=embed8)
      await ctx.reply(f"<:tick:1064554244105052161> | Successfully Removed `Bug Hunter` Badge From **{member}**")
    elif badge.lower() in ["all"]:
      idk = "**<:RC_OWNER:1025209930719969382>ㆍOwner\n<:jr_staff:1025210867987521557>ㆍStaff\n<a:_partner:1025211207566753914>ㆍPartner\n<:astroz_spo:1025212082532122685>ㆍSponsor\n<:RC_FRIENDS:1025209342674346097>ㆍOwner`s Friends\n<a:early:1002225237292744784>ㆍEarly Supporter\n<a:durex_vip:1025212603909296129>ㆍVip\n<a:astroz_1212:1002017580569084037>ㆍBug Hunter**"
      ok.remove(idk)
      makebadges(member.id, ok)
      embedall = discord.Embed(
                title="AASHIQUII",
                description=f"<:tick:1064554244105052161> | **Successfully Removed `All` Badges From {member}**",
                color=0x00FFE4
       )
      #embedall.set_footer(text=f"Made With 💖 By villan#0774",icon_url= "https://cdn.discordapp.com/avatars/980359292840472597/a_dbfc76aa89c069c0f1f0dd705e2a91c9.gif?size=2048")
      #embedall.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048") 
