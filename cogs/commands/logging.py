...
class Logging(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.connection = mongodb.AsyncIOMotorClient("mongodb+srv://villan6278:8789693890@cluster0.x29qwdt.mongodb.net/?retryWrites=true&w=majority")
    ...
    async def channel(self, ctx, c: discord.TextChannel):
        try:
            ...
            embed = discord.Embed(
        description = f'<:tick:1064554244105052161>  | All logs channel are updated to <#{c.id}>',
        color=0x00FFE4
      )
            ...
            #embed.set_footer(text="Made With 💖 By villan#0774",icon_url="https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
    ...
    async def delete(self, ctx: commands.Context):
        ...
        embed = discord.Embed(
        description = f'<:tick:1064554244105052161> | Successfully Deleted Logging Channel',
        color=0x00FFE4
      )
        embed.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
       # embed.set_thumbnail(url = "https://cdn.discordapp.com/avatars/1024854362801057884/af987937665a69cc5fc01f587179d7ae.webp?size=2048")
        #embed.set_footer(text="Made With 💖 villan",icon_url="https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        await ctx.send(embed=embed)
