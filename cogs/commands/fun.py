     ...
     async with aiohttp.ClientSession() as a:
       async with a.get(f"http://ipwhois.app/json/{ip}") as b:
         ...
         try:
           ...
           embed.set_footer(text='Thanks For Using AASHIQI',icon_url="https://cdn.discordapp.com/avatars/1060411506346446908/87cdd0ff2eacd9235ab19953d0236b35.png?size=1024")
           await ctx.send(embed=embed)
         except KeyError:
          embed = discord.Embed(
