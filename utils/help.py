...
class View(discord.ui.View):
	...
	def hacker(self):
		inv = Buttons(label='Invite Me', style=discord.ButtonStyle.link, url='https://discord.com/api/oauth2/authorize?client_id=1060411506346446908&permissions=8&scope=bot')
		sup = Buttons(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.gg/GTzUd3Ux')
		hack = [inv, sup]
